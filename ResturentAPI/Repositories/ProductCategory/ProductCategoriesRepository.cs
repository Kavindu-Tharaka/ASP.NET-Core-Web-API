...
namespace ResturentAPI.Repositories.ProductCategory
{
    public class ProductCategoriesRepository : IProductCategoriesRepository
    {
        ...
        public async Task<int> AddProductCategory(ProductCategoryModel productCategoryModel)
        {
        ...
        public async Task<List<ProductCategoryModel>> GetAllProductCategories()
        {
            ...
            return mapper.Map<List<ProductCategoryModel>>(records);
        }
        ...
        public async Task<ProductCategoryModel> GetProductCategoryById(int id)
        {
            ...
            return mapper.Map<ProductCategoryModel>(productCategory);
        }
